  ...
  return (
    <>
      <div
        ...
        className="flex flex-col justify-around h-48 bg-gray-800 rounded-lg p-4 cursor-default"
      >
        <div className="flex">
          ...
          <div className="grid grid-cols-1">
            ...
            {authUser._id === post.user._id && (
              <button
                ...
                className="btn btn-md w-full hover:text-red-500 mt-4"
              >
                {postId === post._id ? <LoadingState /> : <Trash />}
              </button>
            )}
          </div>
        </div>
